...
pip3 install -r /opt/my-resources/bin/DefaultCreds-cheat-sheet/requirements.txt
cp /opt/my-resources/bin/DefaultCreds-cheat-sheet/creds /usr/bin/
chmod +x /usr/bin/cred
